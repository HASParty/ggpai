...
namespace Behaviour {
	public class Pointing : BMLChunk {
		...
		{
			return string.Format ("[Pointing: Start={0}, End={1}, Mode={2}, Target={3}, Ready={4}, StrokeStart={5}, Stroke={6}, StrokeEnd={7}, Relax={8}]", Start, End, Mode, Target, Ready, StrokeStart, Stroke, StrokeEnd, Relax);
		}
	}
}
