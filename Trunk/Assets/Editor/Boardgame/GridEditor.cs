...
namespace Boardgame {
	...
	public class GridEditor : Editor {
        ...
        {
            MeshFilter meshfilter = board.gameObject.GetComponentInChildren<MeshFilter>();
            ...
            float offsetY = board.transform.position.y + meshfilter.sharedMesh.bounds.extents.y * board.transform.lossyScale.y;
